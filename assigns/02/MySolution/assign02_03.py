...
def mylist_mergesort(xs):
    ...
    def mymerge(ys, zs):
        if mylist_nilq(ys):
            ...
            if mylist_nilq(zs):
                ...
                zs = zs.cons2
                if y1 <= z1:
                    return mylist_cons(y1, mymerge(ys, mylist_cons(z1, zs)))
                else:
                    return mylist_cons(z1, mymerge(mylist_cons(y1, ys), zs))
    ...
    if mylist_nilq(xs):
        ...
        if mylist_nilq(xs):
            ...
            xs = xs.cons2
            (ys, zs) = mysplit(xs)
            return mymerge(mylist_mergesort(mylist_cons(x1, ys)), mylist_mergesort(mylist_cons(x2, zs)))